...
// static members
Option ModelWifiRanger::Vis::showTransducers("Ranger transducers", "show_ranger_transducers", "", false,
                                         NULL);
Option ModelWifiRanger::Vis::showArea("Ranger area", "show_ranger_ranges", "", true, NULL);
Option ModelWifiRanger::Vis::showStrikes("Ranger strikes", "show_ranger_strikes", "", false, NULL);
Option ModelWifiRanger::Vis::showFov("Ranger FOV", "show_ranger_fov", "", false, NULL);
// Option ModelWifiRanger::Vis::showBeams( "Ranger beams", "show_ranger_beams", "",
// false, NULL );

ModelWifiRanger::ModelWifiRanger(World *world, Model *parent, const std::string &type)
//    : ModelRanger(world, parent, type, false), vis(world)
    : Model(world, parent, type), vis(world)
{
 PRINT_DEBUG2("Constructing ModelWifiRanger %u (%s)\n", id, type.c_str());
...
ModelWifiRanger::~ModelWifiRanger()
{
}

void ModelWifiRanger::Startup(void)
{
  Model::Startup();
  this->SetWatts(RANGER_WATTSPERSENSOR * sensors.size());
}

void ModelWifiRanger::Shutdown(void)
{
...
void ModelWifiRanger::LoadSensor(Worldfile *wf, int entity)
{
  Sensor s;
  s.Load(wf, entity);
  sensors.push_back(s);
...
void ModelWifiRanger::Sensor::Load(Worldfile *wf, int entity)
{
...
void ModelWifiRanger::Print(char *prefix) const
{
  Model::Print(prefix);
...
ModelWifiRanger::Vis::Vis(World *world) : Visualizer("Ranger", "ranger_vis")
{
...
void ModelWifiRanger::Vis::Visualize(Model *mod, Camera *cam)
{
  (void)cam; // avoid warning about unused var

  ModelWifiRanger *ranger(dynamic_cast<ModelWifiRanger *>(mod));
